...
//    @Test
    public void hash() throws Exception {
        ...
        log.info("Hash crc32c: {} | {}", Files.hash(file, Hashing.crc32c()).toString(), System.currentTimeMillis() - start);
        start = System.currentTimeMillis();
        log.info("Hash sha256: {} | {}", Files.hash(file, Hashing.sha256()).toString(), System.currentTimeMillis() - start);
        start = System.currentTimeMillis();
        log.info("Hash adler32: {} | {}", Files.hash(file, Hashing.adler32()).toString(), System.currentTimeMillis() - start);
    }
...
//        Matcher matcher = Pattern.compile("(\\w{2})\\w{14}(\\w{2})\\w+").matcher(input);
